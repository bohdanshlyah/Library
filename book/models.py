...
class Book(models.Model):
    ...
    image = models.CharField(max_length=200, default="https://edit.org/images/cat/book-covers-big-2019101610.jpg")
    ...
    def __str__(self):
        ...
        return f"{self.name} by {self.get_authors()}"
    ...
    def get_author(self):
        return list(self.authors.all())[0].short_name()

    def get_authors(self):
        return ', '.join([a.name + " "  + a.surname for a in self.authors.all()])

    def get_author_url(self):
        return '../authors/' + list(self.authors.all())[0].get_url()

    def get_url(self):
        return '/books/' + str(self.id)
